...
if cpu_avg > 90 and gpu_avg > 90:
    utilization_comment = "Both CPU and GPU are nearing full capacity."
...
if gpu_max_q > cpu_max_q + 2:
    ...
    queue_comment = "CPU queue has been more congested during this time."
else:
    queue_comment = "Queue delays are balanced across CPU and GPU."
...
nl_summary = summarizer(summary, max_length=100, min_length=30, do_sample=False)[0]["summary_text"]
